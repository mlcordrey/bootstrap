...
/* menu li size */
function menu_w() {
	var count_li = jQuery('.menu_block ul li').not('ul ul li').length;
	var nav_w = jQuery('.menu_block').width();
	var nav_w_li = nav_w/(count_li) -3;
	
	jQuery('.menu_block ul li').not('ul ul li').css('width', nav_w_li + 'px');
    ...
    methods = {
      init: function(options) {
        ...
        return this.each(function() {
          ...
          stickyWrapper.css('height', stickyElement.outerHeight() - 18);
          sticked.push({
